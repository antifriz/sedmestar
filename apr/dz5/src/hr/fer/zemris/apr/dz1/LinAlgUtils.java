...
public class LinAlgUtils {
    public static Matrix solveSystem(Matrix system, Matrix rhs, Method method) throws ArithmeticException {
        ...
        return solveSystem(rhs, matrix, transform);
    }

    protected static Matrix solveSystem(Matrix rhs, Matrix decomposed, Matrix transform) {
        Matrix u = decomposed.extractUpper();
        Matrix l = decomposed.extractLower();
